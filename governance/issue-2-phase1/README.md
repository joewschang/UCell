...
3. `PAGE_MAPPING.md`
4. `COMPONENT_SPEC.md`
5. `TERMINOLOGY_AUDIT.md`
6. `MEMBER-LOW-FIDELITY-WIREFRAMES.md`
7. `ADMIN-LOW-FIDELITY-WIREFRAMES.md`

Evidence sources: React route trees, navigation/role maps, UI API clients, NestJS controllers/services, OpenAPI, Design System v1 freeze, UX-3 evidence, and `governance/user-guide/local-test-20260918/`.
