...
| Security login/denied access/role change | Session/link/rebind and HTTP outcome evidence exist; explicit login/role event coverage remains incomplete | PARTIAL |
