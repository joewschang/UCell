Original baseline: 148. Current TODO: 102. Net placeholder reduction: 46.
...
| backend/apps/api/test/v063-golden-path.e2e-spec.ts | 25 | Taiwan local time maps to configured settlement week | Test implementation; SSOT/evidence review before conversion |
| backend/apps/api/test/v063-golden-path.e2e-spec.ts | 43 | payout groups by Qualification rather than Person | Test implementation; SSOT/evidence review before conversion |
| backend/apps/api/test/v063-golden-path.e2e-spec.ts | 44 | Recovery offsets Gross without changing source Award | Test implementation; SSOT/evidence review before conversion |
| backend/apps/api/test/v063-golden-path.e2e-spec.ts | 45 | Net payout never becomes negative | Test implementation; SSOT/evidence review before conversion |
