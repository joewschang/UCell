...
| Admin Subscription page | Replaced raw JSON workbench with bounded/filterable Core plans/list/schedule details and error/empty/retry states; Backend create now requires versioned calendar parameters and stores snapshot hashes | Create/cancel remain unavailable in this page; cancellation idempotency/rollback, formal Production operational dates and refund verification remain incomplete |
