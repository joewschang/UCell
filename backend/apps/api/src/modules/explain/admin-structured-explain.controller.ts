...
export class AdminStructuredExplainController {
 ...
 @ApiOperation({operationId:'adminExplainReservoir',description:'Stored Reservoir A accrual/correction, requires live Entra finance/audit grant. Reservoir B always returns NOT_ACTIVATED pending company profile binding.'})
