...
@Module({imports:[AuthModule,OrderModule],controllers:[MemberAuthController,MemberController],providers:[MemberService,MemberReadService,MemberShareLinkService,MemberContextGuard,LineTokenVerifierService]})
