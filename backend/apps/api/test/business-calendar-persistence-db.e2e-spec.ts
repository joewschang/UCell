...
if(!['localhost','127.0.0.1'].includes(parsed.hostname)||!(parsed.pathname.slice(1).endsWith('_test') || /^ucell_jest_[a-f0-9]{32}$/.test(parsed.pathname.slice(1)))) throw new Error('CALENDAR_PERSISTENCE_TEST_DATABASE_REQUIRED');
