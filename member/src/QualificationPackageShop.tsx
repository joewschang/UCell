...
import {createQualificationPackageOrder,getDeliveryProfile,getPackageProducts,getQualificationPackages,type PackageOffer} from './memberData';
...
function PackageSelection({offer,onCancel,onCreated}:{offer:PackageOffer;onCancel:()=>void;onCreated:()=>void}){
